...
def checkout(request):
    if request.method== "POST":
        ...
        #Requesting payment gateway to transfer the money to your account after payment by the user
    return render(request, 'shop/checkout.html')

@csrf_exempt
def handlerequest(request):
    #payment gateway website will send there POST request here
    pass
